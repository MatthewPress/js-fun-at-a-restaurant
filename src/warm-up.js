...
console.log(inStock, shouldOrderMore);
//------------------------- Conditionals -------------------------//
...
var vegetables = ["lettuce", "cucumber", "spinach", "artichoke", "onion"];
...
var fruits = ["apple", "banana", "pear", "melon", "grape", "kiwi", "mango"];

// Write the code to access the 5th element of the array, using bracket notation.

var favFruit = fruits[4];

console.log(vegetables, favVeg, fruits, favFruit);
//------------------------- Objects -------------------------//
